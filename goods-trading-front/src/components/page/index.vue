    ...
    <div>
        ...
        <app-body>
            ...
            <el-tabs v-model="labelName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="手袋" name="1"></el-tab-pane>
                <el-tab-pane label="电脑" name="2"></el-tab-pane>
                <el-tab-pane label="手机" name="3"></el-tab-pane>
                <el-tab-pane label="时尚杂志" name="4"></el-tab-pane>
                <el-tab-pane label="其他" name="5"></el-tab-pane>
            </el-tabs>

             <!--<el-menu  mode="horizontal" @select="handleSelect">
                    <el-menu-item >全部</el-menu-item>
                    <el-submenu ><template slot="title">手袋</template></el-submenu>
                    <el-submenu><template slot="title">电脑</template></el-submenu>
                    <el-submenu><template slot="title">手机</template></el-submenu>
                    <el-submenu><template slot="title">时尚杂志</template></el-submenu>
